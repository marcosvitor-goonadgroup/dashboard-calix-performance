                ...
                <div className="bg-gray-50 rounded-lg p-4">
                  ...
                  <ResponsiveContainer width="100%" height={250}>
                    <AreaChart data={retentionData}>
                      ...
                      />
                      <Tooltip
                        formatter={(value: unknown) => { const v = typeof value === 'number' ? value : undefined; return [v !== undefined ? formatNumber(v) : '', 'Visualizações']; }}
                        contentStyle={{
              ...
              <div className="bg-gray-50 rounded-lg p-4">
                ...
                <ResponsiveContainer width="100%" height={250}>
                  <AreaChart data={timelineData}>
                    ...
                    />
                    <Tooltip
                      formatter={(value: unknown) => { const v = typeof value === 'number' ? value : undefined; return [v !== undefined ? formatNumber(v) : '', selectedMetric.charAt(0).toUpperCase() + selectedMetric.slice(1)]; }}
                      contentStyle={{
                        backgroundColor: 'white',
                        border: '1px solid #e5e7eb',
                        borderRadius: '8px'
